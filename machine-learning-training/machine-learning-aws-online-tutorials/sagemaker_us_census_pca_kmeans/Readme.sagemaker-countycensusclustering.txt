   ...
   Code: sagemaker-countycensusclustering.ipynb


        >>> # Install dependencies
        >>> import sys

        >>> # smdebug: This library powers Amazon SageMaker Debugger, and helps you develop better, faster and cheaper models by catching common errors quickly
        >>> !{sys.executable} -m pip install smdebug
        >>> !{sys.executable} -m pip install seaborn
        >>> # plotly: Plotly's Python graphing library makes interactive, publication-quality graphs. Examples of how to make line plots, scatter 
        >>> #  plots, area charts, bar charts, error bars, box plots, histograms, heatmaps, subplots, multiple-axes, polar charts, and bubble charts
        >>> !{sys.executable} -m pip install plotly
        >>> # opencv: OpenCV python is an open-source library for machine learning, image processing, and computer vision.
        >>> !{sys.executable} -m pip install opencv-python
        >>> # shap: SHAP values, which measure how much each feature (such as income, age, credit score, etc.) contributes to the model's prediction. 
        >>> !{sys.executable} -m pip install shap
        >>> # used to make highly interactive graphs and visualizations. This is done in bokeh using HTML and JavaScript.
        >>> !{sys.executable} -m pip install bokeh
        >>> # imageio# provides an easy interface to read and write a wide range of image data, including animated images, volumetric data, and scientific formats.
        ...
        >>> import sagemaker
            ...
            #   code cells. That is, the plots are displayed inline within the notebook, rather than in a separate window or output cell.
        >>> %matplotlib', 'inline
        ...
        >>> import seaborn as sns
            ...
            #  style.uses("ggplot"): mathplotlib adjusts the style to emulate ggplot (a popular plotting package for R
